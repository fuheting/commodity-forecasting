...
from tests.support.historical_weekly_fixture import fixture_hash, weekly_target_rows
from tools.capability_probes.contracts import FIXTURE_ID
from tools.capability_probes.evidence import EvidenceError, validate_evidence_record, write_evidence
from tools.capability_probes.guards import (
    CatalogError,
    LeakageError,
    RoadmapGateError,
...
def _valid_record() -> dict[str, object]:
    return {
        ...
        "mode": "network-smoke",
        "command": "pytest tests/acceptance/capability_probes/test_covariate_support.py",
        "tool": "pytest",
