...
| ---: | --- | --- | --- | --- | --- | --- | ---: |
| 1 | `amazon/chronos-2` | `pass` | `True` | `both` | `success` | 511798272 bytes (torch_cuda_max_memory_allocated) | 73.866846 |
| 2 | `autogluon/chronos-2-synth` | `pass` | `True` | `both` | `success` | 509765632 bytes (torch_cuda_max_memory_allocated) | 76.883530 |
| 3 | `autogluon/chronos-2-small` | `pass` | `True` | `both` | `success` | 145472512 bytes (torch_cuda_max_memory_allocated) | 70.260929 |
| 4 | `google/timesfm-1.0-200m-pytorch` | `fail` | `False` | `none` | `incomplete` | unmeasured | 44.858157 |
| 5 | `google/timesfm-2.5-200m-transformers` | `unsupported` | `False` | `none` | `incomplete` | unmeasured | 25.116840 |

## Attempt evidence

### `amazon/chronos-2`

- `connected_point`: `success`; device `cuda:0:NVIDIA RTX PRO 4000 Blackwell Generation Laptop GPU`; device policy `gpu_required`; network policy `http_proxy_without_socks_fallback`; acquisition `downloaded`; unique_id, ds, P105
...
- `connected_point`: `failed`; device `cuda:0:NVIDIA RTX PRO 4000 Blackwell Generation Laptop GPU`; device policy `gpu_required`; network policy `http_proxy_without_socks_fallback`; acquisition `downloaded`; shape '[1, -1, 32]' is invalid for input of size 60
