...
from .contracts import CATALOG_REQUIRED_FIELDS, FIXTURE_ID
from .evidence import utc_timestamp, write_evidence
from .paths import phase0_evidence_dir, phase0_findings_dir, repo_root
from .datasource_selection import PINK_SHEET_DATASET_ID, datasource_candidates
...
def run_probe(*, root: Path | None = None) -> tuple[dict[str, Any], list[dict[str, Any]]]:
    ...
    record = {
        ...
        "mode": "offline-unit",
        "command": ".venv/bin/python -m pytest tests/acceptance/capability_probes/test_data_catalog.py",
