...
from .contracts import FIXTURE_ID, CovariateCapability, CovariateGateResult
...
def run_probe(*, root: Path | None = None) -> dict[str, Any]:
    ...
    command = ".venv/bin/python -m pytest tests/acceptance/capability_probes/test_covariate_support.py"
