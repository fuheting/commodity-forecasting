...
from .contracts import FIXTURE_ID, ProbabilisticGateResult, ProbabilisticOutputKind
...
def run_probe(*, root: Path | None = None) -> dict[str, Any]:
    ...
    command = ".venv/bin/python -m pytest tests/acceptance/capability_probes/test_probabilistic_adapters.py"
